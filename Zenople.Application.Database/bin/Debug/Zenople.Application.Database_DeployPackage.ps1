...
$TargetDatabase = 'ZenopleMaster'
$OctoOptionDeployToLocalInstance = ''
$SkipVariableValidation = ''
$__isAzurePlatformTarget = 'False'
$CreateScriptFileName = 'Zenople.Application.Database_Package.sql'
$SnapshotPackageFileName = 'Zenople.Application.Database_Snapshot.nupkg.bin'
